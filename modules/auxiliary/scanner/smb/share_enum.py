...
class Module(Auxiliary, Smb_scanner_client):
    ...
    __info__ = {
        ...
        "description": (
            ...
            "available shares with optional top-level directory listing. Intended for "
            "reconnaissance during an engagement, not as a one-shot vulnerability check."
        ),
        "author": "KittySploit Team",
        "tags": ["smb", "auxiliary", "enumeration", "shares", "windows"],
    'agent': {
        'risk': 'active',
