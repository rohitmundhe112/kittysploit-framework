...
"""
Windows Python Meterpreter Bind TCP Payload
Author: KittySploit Team
Version: 2.0.0

This payload creates a small Meterpreter stager that listens on the target,
accepts a connection from the handler, receives the full Meterpreter stage
code, and executes it directly in memory.
...
class Module(Payload):
    __info__ = {
        'name': 'Windows Python Meterpreter, Bind TCP',
        'description': 'Small Meterpreter stager for Windows - bind TCP (requires Python on target)',
        'author': 'KittySploit Team',
        'version': '2.0.0',
        'category': 'singles',
        'arch': Arch.PYTHON,
